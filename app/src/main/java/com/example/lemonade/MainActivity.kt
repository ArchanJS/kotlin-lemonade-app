...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        headerText= findViewById(R.id.text_action)
        setViewElements()
        lemonImage!!.setOnClickListener {
            // TODO: call the method that handles the state when the image is clicked
//            Toast.makeText(this,lemonadeState,Toast.LENGTH_SHORT).show()
            clickLemonImage()
    ...
    private fun clickLemonImage() {
        ...
        when(lemonadeState){
            SELECT->{
                ...
                squeezeCount=0
                Toast.makeText(this,"You need to squeeze "+lemonSize.toString()+" times!",Toast.LENGTH_SHORT).show()
            ...
            SQUEEZE->{
                ...
                if(lemonSize>0) Toast.makeText(this,lemonSize.toString()+" squeezes left, keep squeezing!",Toast.LENGTH_SHORT).show()
                else Toast.makeText(this,"Enjoy your drink!",Toast.LENGTH_SHORT).show()
                if(lemonSize==0) {
                    lemonadeState=DRINK
    ...
    private fun setViewElements() {
        val headerText: TextView = findViewById(R.id.text_action)
        ...
        when(lemonadeState){
            SELECT->headerText?.setText("Click to select a lemon!")
            SQUEEZE->headerText?.setText("Click to squeeze!")
            DRINK->headerText?.setText("Click to drink!")
            RESTART->headerText?.setText("Click to restart!")
